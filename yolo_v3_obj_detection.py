...
def _conv_block(inp, convs, skip=True):
    """
    This function is used to create block of layers
    :param inp:
    :param convs:
    :param skip:
    :return:
...
def bbox_iou(box1, box2):
    """
    This function is used to evaluate the Intersection over Union(IoU) evaluation metric
    :param box1: specifies the bounding box coordinates for one bounding box
    :param box2: specifies the bounding box coordinates for other bounding box
    :return:
    """
...
def make_yolov3_model():
    """
    This function specifies the architecture of the YOLO model
    :return: return the YOLO model
    """
...
def preprocess_input(image, net_h, net_w):
    ...
    :param image: specifies the input image
    :param net_h: specifies the height of the input image
    :param net_w: specifies the width of the input image
